# coding: utf-8
"""
High-throughput magnetic-ordering and SOC workflow for permanent-magnet
screening.

This module extends atomate's magnetic ordering workflow with spin-orbit
coupling calculations over selected magnetization directions. It can use either
primitive or conventional standardized cells for the SOC branch, and is intended
for comparing FM/AFM magnetic orderings and preparing magnetic anisotropy energy
(MAE) data for hexagonal, trigonal, and tetragonal crystal systems.

Workflow summary:
    1. Enumerate candidate collinear magnetic orderings with pymatgen.
...
class MagneticOrderingsSOCWF:
    def __init__(
        ...
        # pymatgen generates FM/AFM candidate structures and records their
        # origins. These structures are later relaxed and ranked by energy.
